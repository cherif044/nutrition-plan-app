...
(async () => {
  ...
  assert(dashboardHtml.includes('class="dashboard-action-tile" href="/explorer"'), 'browse-folders action card is clickable');
  ...
  assert(dashboardJs.includes('card.href = planHref(plan)'), 'recent plan cards link to the planner');
  assert(dashboardJs.includes('last_opened_at'), 'recent plan cards use last-opened timestamps');
